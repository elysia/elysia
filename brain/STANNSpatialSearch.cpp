...
**/
Neuron* STANNSpatialSearch::findNearestNeighbor(const Vector3f &queryPoint, Neuron* exclude){
...
**/
void STANNSpatialSearch::addNeighbor(Neuron* neuron){
...
**/
void STANNSpatialSearch::removeNeighbor(Neuron* neuron){
...
**/
void STANNSpatialSearch::moveNeighbor(Neuron*){
}
}
