...
#ifndef _ELYSIA_CORE_UTIL_UNIQUE_ID_HPP_
#define _ELYSIA_CORE_UTIL_UNIQUE_ID_HPP_
 ...
 *  used.
 */
class ELYSIA_EXPORT UniqueID16 {
public:
    uint16 operator()() {
        uint16 retval;
        do {
 ...
 *  used.
 */
class ELYSIA_EXPORT UniqueID32 {
public:
    uint32 operator()() {
        uint32 retval;
        do {
 ...
 *  used.
 */
class ELYSIA_EXPORT UniqueID64 {
public:
    uint64 operator()() {
        uint64 retval;
#if ELYSIA_PLATFORM == ELYSIA_PLATFORM_WINDOWS
...
#endif //_ELYSIA_CORE_UTIL_UNIQUE_ID_HPP_
