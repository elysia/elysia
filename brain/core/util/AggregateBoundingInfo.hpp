...
#ifndef _ELYSIA_LIBCORE_AGGREGATE_BOUNDING_INFO_HPP_
#define _ELYSIA_LIBCORE_AGGREGATE_BOUNDING_INFO_HPP_
...
#endif //_ELYSIA_LIBCORE_AGGREGATE_BOUNDING_INFO_HPP_
